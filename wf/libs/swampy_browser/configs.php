...
require(str_replace("\\", "/", dirname(__FILE__)) . '/../../../WfConfig.php');

$HOST = WfConfig::$site_url;

// absolute path to your public_html directory
$PUBLIC_HTML_DIR = WfConfig::$base;
...
$DIRS = array
(
	array('title'=>"Text images",	'dir'=>"site/bins/uploads/images/text/"),
	array('title'=>"Gallery images",'dir'=>"site/bins/uploads/images/gallery/"),
);
/*
